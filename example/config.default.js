...
var config = {
  ...
  site_title: 'docAPPT Docs',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '',

  // Used for the "Get in touch" page footer link
  support_email: 'thepcmrtim@gmail.com',

  // Footer Text / Copyright
  copyright: 'Copyright &copy; ' + new Date().getFullYear() +' NguyenTech LLC - <a href="http://raneto.com">Powered by Raneto</a>',
